...
class ProductList extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <select className="ProductList-div-select" onChange={(event) => this.orderByHandle(event)}>
        ...
        <div className="ProductList-div">
          <Products items={this.orderBy()} addToCart={addToCart} decreaseAvailability={decreaseAvailability} />
        </div>
      </div>
    );
  }
